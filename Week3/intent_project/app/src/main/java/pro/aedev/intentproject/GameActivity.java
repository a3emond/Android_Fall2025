...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Greet player with name from Intent
        //name = (getIntent() != null && getIntent().hasExtra("playerName")) ? getIntent().getStringExtra("playerName") : "Player";

        String name = Optional.ofNullable(getIntent())
                .filter(i -> i.hasExtra("playerName"))
                .map(i -> i.getStringExtra("playerName"))
                .orElse("Player");


        txtHello = findViewById(R.id.txtHello);
        txtHello.setText(getString(R.string.welcome_message, name));
